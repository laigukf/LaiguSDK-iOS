...
static NSString *const LGBlueColor = @"#17c7d1";
static NSString *const LGSilverColor = @"#c6cbd0";

typedef NS_ENUM(NSUInteger, LGChatViewStyleType) {
    LGChatViewStyleTypeDefault,
    LGChatViewStyleTypeBlue,
    LGChatViewStyleTypeGreen,
    LGChatViewStyleTypeDark,
};

@interface LGChatViewStyle : NSObject
