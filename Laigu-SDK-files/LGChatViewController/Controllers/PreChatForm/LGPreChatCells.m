...
@implementation LGPreChatSelectionCell
...
@implementation LGPrechatSingleLineTextCell
...
@implementation LGPreChatMultiLineTextCell
...
@implementation LGPreChatCaptchaCell
...
@implementation LGPreChatSectionHeaderView
...
- (void)updateUI {
    ...
    self.typeLabel.text = self.formItem.type == LGPreChatFormItemInputTypeMultipleSelection ? @"(多选)" : @"";
...
- (void)setFormItem:(LGPreChatFormItem *)formItem {
    _formItem = formItem;
    [self updateUI];
}
