...
static CGFloat const kLGBotMenuTextSize = 15.0;
static CGFloat const kLGBotMenuReplyTipSize = 12.0;
static CGFloat const kLGBotMenuVerticalSpacingInMenus = 12.0;
static NSString * const kLGBotMenuTipText = @"点击问题或回复对应数字查看答案";

/**
 * LGTextCellModel定义了文字消息的基本类型数据，包括产生cell的内部所有view的显示数据，cell内部元素的frame等
 * @warning LGTextCellModel必须满足LGCellModelProtocol协议
 */
@interface LGBotMenuCellModel : NSObject <LGCellModelProtocol>
