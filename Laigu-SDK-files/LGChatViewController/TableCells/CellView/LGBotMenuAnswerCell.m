...
@interface LGBotMenuAnswerCell()

@property (nonatomic, strong) LGBotMenuAnswerCellModel *cellModel;
...
@implementation LGBotMenuAnswerCell
...
- (void)updateUI {
    ...
    [self.contentLabel align:(ViewAlignmentTopLeft) relativeToPoint:CGPointMake(kLGCellAvatarToHorizontalEdgeSpacing, kLGCellAvatarToHorizontalEdgeSpacing)];
...
- (UIView *)menusView:(NSArray *)menus {
    ...
    for (NSString *menuTitle in menus) {
        ...
        menu.viewHeight = [LGStringSizeUtil getHeightForText:menuTitle withFont:[UIFont systemFontOfSize:FONT_SIZE_MENU] andWidth:container.viewWidth];
