//
//  LGBotMenuWebViewBubbleAnswerCell.m
//  Laigu-SDK-Demo
//
...
@interface LGBotMenuWebViewBubbleAnswerCell()

@property (nonatomic, strong) LGBotMenuWebViewBubbleAnswerCellModel *viewModel;
...
@implementation LGBotMenuWebViewBubbleAnswerCell
...
//    self.itemsView.viewWidth = [[UIScreen mainScreen]bounds].size.width - kLGCellBubbleMaxWidthToEdgeSpacing - self.avatarImageView.viewRightEdge;
...
//    self.currentCellWidth = self.contentView.viewWidth;
    ...
    self.currentContentWidth = self.itemsView.viewWidth - kLGCellAvatarToHorizontalEdgeSpacing - kLGCellAvatarToHorizontalEdgeSpacing;
}
...
- (UIImageView *)itemsView {
    if (!_itemsView) {
        ...
        NSInteger itemsViewX = kLGCellAvatarToVerticalEdgeSpacing+kLGCellAvatarDiameter+kLGCellAvatarToBubbleSpacing;
        _itemsView.frame = CGRectMake(itemsViewX,kLGCellAvatarToHorizontalEdgeSpacing,LGToolUtil.kXlpScreenWidth - itemsViewX - kLGCellBubbleMaxWidthToEdgeSpacing , 200);
...
- (UIImageView *)avatarImageView {
    if (!_avatarImageView) {
        ...
        _avatarImageView.frame = CGRectMake(kLGCellAvatarToVerticalEdgeSpacing, kLGCellAvatarToHorizontalEdgeSpacing, kLGCellAvatarDiameter, kLGCellAvatarDiameter);
...
//        menu.autoresizingMask = UIViewAutoresizingFlexibleWidth;
        ...
        [menu setTitleColor:[LGChatViewConfig sharedConfig].chatViewStyle.btnTextColor forState:(UIControlStateNormal)];
...
//        menu.backgroundColor = [UIColor redColor];
        menu.viewHeight = [LGStringSizeUtil getHeightForText:menuTitle withFont:[UIFont systemFontOfSize:FONT_SIZE_MENU] andWidth:self.contentWebView.frame.size.width];
