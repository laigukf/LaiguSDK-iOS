...
@protocol LGCellModelProtocol;

/**
 * 所有的集成的cell需要满足的协议
 */
@protocol LGChatCellProtocol <NSObject>
 ...
 * 所有cell的代理方法
 */
@protocol LGChatCellDelegate <NSObject>
...
/**
 * LGChatBaseCell定义了客服聊天界面所有cell的父cell，开发者自定义的Cell请继承该Cell
 */
@interface LGChatBaseCell : UITableViewCell <LGChatCellProtocol>
