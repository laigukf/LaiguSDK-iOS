...
@interface LGChatAudioRecorder() <MLAudioRecorderDelegate>
...
@implementation LGChatAudioRecorder {
    //是否取消了录音
...
- (instancetype)initWithMaxRecordDuration:(NSTimeInterval)duration {
    ...
    if (self) {
        ...
        meterObserver.errorBlock = ^(NSError *error,MLAudioMeterObserver *meterObserver){
            [[[UIAlertView alloc]initWithTitle:[LGBundleUtil localizedStringForKey:@"record_error"] message:error.userInfo[NSLocalizedDescriptionKey] delegate:nil cancelButtonTitle:nil otherButtonTitles:[LGBundleUtil localizedStringForKey:@"user_confirm"], nil]show];
        };
