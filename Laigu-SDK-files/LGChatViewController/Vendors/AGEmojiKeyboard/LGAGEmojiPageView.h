...
@protocol LGAGEmojiPageViewDelegate;

@interface LGAGEmojiPageView : UIView

@property (nonatomic, assign) id<LGAGEmojiPageViewDelegate> delegate;
...
@protocol LGAGEmojiPageViewDelegate <NSObject>
