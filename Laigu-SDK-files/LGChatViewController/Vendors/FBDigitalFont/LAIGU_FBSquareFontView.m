#import "LAIGU_FBSquareFontView.h"
#import "LAIGU_FBFontSymbol.h"
#import "LAIGU_FBSquareFont.h"

@interface LAIGU_FBSquareFontView ()
@property (nonatomic, copy) NSArray *symbols;
@end

@implementation LAIGU_FBSquareFontView
...
- (void)drawRect:(CGRect)rect
{
    ...
    for (i = 0; i < [self.symbols count]; i++) {
        [LAIGU_FBSquareFont drawSymbol:[[self.symbols objectAtIndex:i] intValue]
