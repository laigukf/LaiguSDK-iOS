...
@class LAIGU_MLAudioMeterObserver;

typedef void (^MLAudioMeterObserverActionBlock)(NSArray *levelMeterStates,LAIGU_MLAudioMeterObserver *meterObserver);
typedef void (^MLAudioMeterObserverErrorBlock)(NSError *error,LAIGU_MLAudioMeterObserver *meterObserver);
...
@interface LAIGU_LevelMeterState : NSObject
...
@interface LAIGU_MLAudioMeterObserver : NSObject
{
