...
@implementation LAIGU_LevelMeterState
@end

@interface LAIGU_MLAudioMeterObserver()
...
@implementation LAIGU_MLAudioMeterObserver
...
- (void)refresh
{
    ...
    {
        LAIGU_LevelMeterState *state = [[LAIGU_LevelMeterState alloc]init];
...
+ (Float32)volumeForLevelMeterStates:(NSArray*)levelMeterStates
{
    ...
    {
        averagePowerOfChannels+=((LAIGU_LevelMeterState*)levelMeterStates[i]).mAveragePower;
    }
