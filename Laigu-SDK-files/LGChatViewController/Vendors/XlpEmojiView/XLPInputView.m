...
- (void)layoutBottomBt{
    ...
    [deleteBt setTitle:[LGBundleUtil localizedStringForKey:@"lg_delete"] forState:UIControlStateNormal];
    ...
    [returnBt setTitle:[LGBundleUtil localizedStringForKey:@"lg_send"] forState:UIControlStateNormal];
