...
-(void)commonInit
{
    ...
    [self setImage:[LGAssetUtil imageFromBundleWithName:@"radio_nomal"] forState:UIControlStateNormal];
    [self setImage:[LGAssetUtil imageFromBundleWithName:@"radio_selected"] forState:UIControlStateSelected];
}
