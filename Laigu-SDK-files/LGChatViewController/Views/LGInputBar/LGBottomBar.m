...
- (instancetype)initWithFrame:(CGRect)frame contentView:(LGInputContentView *)contentView; {
    if (self = [super initWithFrame:frame]) {
        ...
        _buttonGroupBar = [[LGButtonGroupBar alloc] init];
        ...
        if (!self.contentView) {
            _contentView = [[LGInputContentView alloc] init];
        }
...
-(void)setContentViewDelegate:(id<LGInputContentViewDelegate>)contentViewDelegate
{
    self.contentView.delegate = contentViewDelegate;
}

-(void)setButtonGroupDelegate:(id<LGButtonGroupBarDelegate>)buttonGroupDelegate
{
    self.buttonGroupBar.delegate = buttonGroupDelegate;
}

-(id<LGButtonGroupBarDelegate>)buttonGroupDelegate
{
