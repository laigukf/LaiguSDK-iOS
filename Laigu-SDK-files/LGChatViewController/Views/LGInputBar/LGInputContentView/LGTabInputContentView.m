...
@implementation LGTabInputContentView
{
    CALayer *topBoder;
    UIView *tabBackgroud;
}
...
-(instancetype)initWithFrame:(CGRect)frame;
{
    ...
    if (self) {
        self.textField = [[LAIGU_HPGrowingTextView alloc] initWithFrame:CGRectMake(0, 1, self.frame.size.width, self.frame.size.height)];
        self.textField.placeholder = [LGBundleUtil localizedStringForKey:@"input_content"];
